        ...
        return (
            <div className = "mainBlock">
                ...
                <div className = "arrowToLeft" width = "50px">
                    <a id = "linkLeft" href = "inftheory17" title={"Теория к предыдущему заданию"} className = "linkToTheory"><b>&#171;</b></a>
                </div>

                <span  className="theory">
                    <h1>Задание 18: Логические выражения</h1>
                    <br/>
                ...
                <div className = "arrowToRight">
                    <a id = "linkRight" href = "inftheory19" title={"Теория к следующему заданию"} className = "linkToTheory"><b>&#187;</b></a>
                </div>
